...
class _SettingsScreenState extends State<SettingsScreen> {
    ...
    builder: (_) => Padding(
      ...
      child: Column(mainAxisSize: MainAxisSize.min, children: [
        Container(width: 40, height: 4,
            decoration: BoxDecoration(color: const Color(0xFFDDE3ED),
                borderRadius: BorderRadius.circular(4))),
        const SizedBox(height: 22),
        Container(width: 60, height: 60,
          decoration: const BoxDecoration(color: Color(0xFFFFEEEE), shape: BoxShape.circle),
          child: const Icon(Icons.logout_rounded, size: 28, color: Color(0xFFD14A4A))),
        const SizedBox(height: 14),
        const Text('Log Out?', style: TextStyle(fontSize: 17, fontWeight: FontWeight.w800)),
        ...
        Row(children: [
          ...
          Expanded(child: ElevatedButton(
            ...
            style: ElevatedButton.styleFrom(
                backgroundColor: const Color(0xFFD14A4A), foregroundColor: Colors.white,
          ...
          children: [
            ...
            Padding(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                const SizedBox(height: 8),
                _menuGroup([
                  _menuItem(Icons.notifications_none_rounded, 'Push Notifications',
                      subtitle: 'Order updates & offers',
                      trailing: Switch(value: _pushNotifications,
                  ...
                  _menuItem(Icons.sms_outlined, 'SMS Alerts',
                      ...
                      trailing: Switch(value: _smsAlerts,
                ...
                _menuGroup([
                  ...
                  _menuItem(Icons.fingerprint_rounded, 'Biometric Login',
                      ...
                      trailing: Switch(value: _biometrics,
                          onChanged: (v) => setState(() => _biometrics = v),
                          activeColor: AppColors.green,
                          materialTapTargetSize: MaterialTapTargetSize.shrinkWrap),
                      onTap: () => setState(() => _biometrics = !_biometrics),
                      showChevron: false),
                ...
                _menuGroup([
                  ...
                  _menuItem(Icons.description_outlined, 'Terms & Privacy Policy',
                ...
                Center(child: Text('PharmaFlow v2.4.1 · Made in Kenya 🇰🇪',
    ...
    child: Column(children: [
      ...
      Stack(alignment: Alignment.bottomRight, children: [
        Container(width: 80, height: 80,
          ...
          child: const Icon(Icons.person_rounded, size: 42, color: Color(0xFF6E86AE))),
  ...
  Widget _stat(String value, String label) => Expanded(
    child: Column(children: [
      ...
      const SizedBox(height: 3),
      Text(label, style: const TextStyle(color: Color(0xFFD0F5E8), fontSize: 9.5)),
    ]));

  Widget _statDivider() => Container(width: 1, height: 28,
  ...
  Widget _menuItem(IconData icon, String label, {
    ...
    return Column(children: [
      ...
      if (!isLast) const Divider(height: 1, indent: 62, color: AppColors.border),
    ]);
  }
