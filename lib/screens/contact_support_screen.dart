...
class _ContactSupportScreenState extends State<ContactSupportScreen> {
  ...
  Widget _formView() => SingleChildScrollView(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Row(children: [
            _channelCard(Icons.chat_bubble_outline_rounded, 'Live Chat',
                'Avg. 2 min', AppColors.green, const Color(0xFFE9FAF1)),
            const SizedBox(width: 10),
            _channelCard(Icons.phone_outlined, 'Call Us', '+254 700 123 456',
                const Color(0xFF5B8FC9), const Color(0xFFEAF3FF)),
            const SizedBox(width: 10),
            _channelCard(Icons.email_outlined, 'Email', 'support@pharmaflow',
                const Color(0xFFF0A529), const Color(0xFFFFF5DE)),
          ]),
  ...
  Widget _channelCard(
          IconData icon, String title, String sub, Color color, Color bg) =>
      Expanded(
          child: Container(
